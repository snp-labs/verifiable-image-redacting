...
public:
	...
	{
	  public:
	  	r1cs_gg_ppzksnark_proof<ppT> completment_proof;
		...
		snark_for_filtering_proof(r1cs_gg_ppzksnark_proof<ppT> &&completment_proof, 
...
#include <libsnark/zk_proof_systems/ppzksnark/r1cs_gg_ppzksnark/snark_for_filtering.tcc>
