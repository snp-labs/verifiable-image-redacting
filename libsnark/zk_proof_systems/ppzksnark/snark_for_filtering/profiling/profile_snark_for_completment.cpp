...
#include <libsnark/zk_proof_systems/ppzksnark/snark_for_filtering/examples/run_snark_for_completment.hpp>
...
int main(int argc, const char * argv[])
{
    ...
    run_snark_for_completment<default_r1cs_gg_ppzksnark_pp>(example, test_serialization);
